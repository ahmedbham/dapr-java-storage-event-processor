$resourceGroup = "dapr-eks-rg"
$clusterName = "dapr-aks-cluster"

# Choose a name for your public IP address which we will use in the next steps
$publicIpName = "nginx-public-ip"
...
# helm install nginx-ingress ingress-nginx/nginx-ingress `
